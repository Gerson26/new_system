...
<html lang="es" dir="ltr">
  <head>
    ...
    <title><?=$this->nombresistema;?> - Login</title>
  </head>
  <body>
      ...
      <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
        <form id="formLogin" action="<?php echo constant("URL"); ?>login/acceso" method="post" autocomplete="off">
          ...
          <div class="form-outline mb-4">
            <label class="fw-bold" for="usernameLahe">Usuario</label>
            <input value="" type="text" name="usernameLahe" id="usernameLahe" class="form-control form-control-lg" autofocus />
          </div>
          <!-- Password input -->
          <div class="form-outline mb-4">
            <label class="fw-bold" for="passwordLahe">Contraseña</label>
            <input value="" type="password" name="passwordLahe" id="passwordLahe" class="form-control form-control-lg" />
          </div>
          <!-- Submit button -->
          <button type="submit" class="btn btn-success btn-lg btn-block" id="report-login">Iniciar sesión</button>
        </form>
